describe("Form Test", () => {
    ...
    const specialInstructionsInput = () =>
      cy.get('input[name="siInput"]').should("exist");
    ...
    it("Type in Name Field", () => {
      nameInput().type("Carlos");
      nameInput().should("have.value", "Carlos");
      specialInstructionsInput().type("Please call instead of knocking on door");
      specialInstructionsInput().should(
        "have.value",
        "Please call instead of knocking on door"
      );
    });
